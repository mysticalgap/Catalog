...
namespace Catalog.Controllers
{
    ...
    public class AuthorsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAuthorsForBook(Guid bookId, [FromQuery]AuthorParameters authorParameters)
        {
            ...
            if (book == null)
            {
                _logger.LogInfo($"Company with id: {bookId} doesn't exist in the database.");
            return NotFound();
            }
        ...
        public async Task<IActionResult> GetAuthorForBook(Guid bookId, Guid id)
        {
            ...
            if (book == null)
            {
                _logger.LogInfo($"Book with id: {bookId} doesn't exist in thedatabase.");
            return NotFound();
            }
